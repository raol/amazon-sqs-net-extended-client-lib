...
namespace Amazon.SQS.ExtendedClient.Tests
{
    ...
    {
        [Test]
        public async Task Long_Messages_Async_All_Are_Stored_In_S3()
        {
        ...
        [Test]
        public async Task Long_Messages_Async_S3KeyProvider_Is_Used_If_Configured()
        {
            ...
            sqsMock.Verify(
                s => s.SendMessageBatchAsync(
                    It.Is<SendMessageBatchRequest>(r => r.Entries.All(e => MessagePointerIsCorrect(e.MessageBody, Constants.CustomPrefix) && LargePayloadAttributeIsAdded(e.MessageAttributes))), It.IsAny<CancellationToken>()));
        }
        ...
        [Test]
        public async Task Short_And_Long_Messages_Async_Only_Long_Stored_In_S3()
        {
            var batchRequest = new SendMessageBatchRequest(SQS_QUEUE_NAME, new List<SendMessageBatchRequestEntry>());
            var shortBody = "body";
            ...
            s3Mock.Verify(s => s.PutObjectAsync(It.IsAny<PutObjectRequest>(), It.IsAny<CancellationToken>()), Times.Exactly(2));
            sqsMock.Verify(
                s => s.SendMessageBatchAsync(
                    It.Is<SendMessageBatchRequest>(r =>
                        ...
                        .Where(t => t.Id%2 != 0)
                        .Select(t => t.Entry)
                        .All(e => MessagePointerIsCorrect(e.MessageBody) && LargePayloadAttributeIsAdded(e.MessageAttributes))), It.IsAny<CancellationToken>()));
        }
    }
}